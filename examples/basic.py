...
# TODO these paths seem funky
resdir = join(dirname(dirname(realpath(__file__))), 'res')
...
try:
    ...
    Himage = Image.open(join(resdir, '7in5.bmp'))
    epd.display(epd.getbuffer(Himage))
    time.sleep(2)
    ...
    bmp = Image.open(join(resdir, '100x100.bmp'))
